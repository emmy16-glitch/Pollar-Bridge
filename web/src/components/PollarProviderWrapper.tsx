...
// Publishable key is optional at runtime. When empty the SDK still mounts
// (config fetch fails gracefully) and every page renders its demo fallback.
// Never crash the portal because a key is missing.
